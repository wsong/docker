...
The system df command can be very resource-intensive. It traverses the filesystem
of every container and every volume in the system. You should be careful running
this command in systems with lots of containers or volumes or in systems where
some containers or volumes have very large filesystems with many files. You should
also be careful not to run this command in systems where performance is critical.
